  ...
  return (
    <footer className="bg-gray-50 dark:bg-[#050508] border-t border-gray-200 dark:border-[#1E1E2E] mt-16">
      <div className="max-w-7xl mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-10">
          ...
          <div className="md:col-span-2">
            <div className="flex items-center gap-0.5 mb-3">
              <span className="text-xl font-black font-mono text-slate-800 dark:text-white">HACK</span>
              <span className="text-xl font-black font-mono text-[#059669] dark:text-[#00FF88]">WIRE</span>
            </div>
            <p className="text-gray-500 dark:text-gray-500 text-sm leading-relaxed mb-4 max-w-xs">
            ...
            <p className="text-gray-400 dark:text-gray-600 text-xs font-mono">hackwire.news</p>
          </div>

          {/* Categories */}
          <div>
            <h3 className="text-[#059669] dark:text-[#00FF88] text-xs font-mono font-bold tracking-widest uppercase mb-4">
              Categories
            </h3>
              ...
              {categories.map((cat) => (
                <li key={cat.id}>
                  <Link
                    ...
                    className="text-gray-500 dark:text-gray-500 text-sm font-mono hover:text-[#059669] dark:hover:text-[#00FF88] transition-colors"
                  >
                    {cat.emoji} {cat.label}
                  </Link>
                </li>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-500 font-mono">
              {[
                ...
                <li key={source} className="text-xs hover:text-[#059669] dark:hover:text-[#00FF88] transition-colors">
                  {source}
                </li>
              ))}
            </ul>
        ...
        {/* Bottom bar */}
        <div className="border-t border-gray-200 dark:border-[#1E1E2E] pt-6">
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
            <div className="text-xs text-gray-400 dark:text-gray-600 font-mono max-w-xl">
            ...
            <div className="text-xs text-gray-400 dark:text-gray-700 font-mono flex-shrink-0">
              © 2026 HackWire. All rights reserved.
            </div>
          </div>
        </div>
      </div>
