...
export const articles: Article[] = [
  {
    slug: 'medisecure-healthcare-breach-2025',
    headline: 'MediSecure Health Network Exposes 14 Million Patient Records in Catastrophic Data Breach',
    summary:
...
This breach is the largest US healthcare data breach since Change Healthcare in 2024, which exposed records for a similarly staggering number of Americans. Security researchers warn that healthcare remains the most-targeted sector due to the high black-market value of medical records—typically ten times more valuable than credit card data—and historically underinvested cybersecurity budgets relative to the sensitivity of the data held.`,
    ...
    severity: 'critical',
    tags: ['healthcare', 'HIPAA', 'ransomware', 'BlackSuit', 'data breach'],
  },
  {
    slug: 'voltzite-ransomware-critical-infrastructure',
    headline: 'VoltZite Ransomware Targets Power Grid Operators Across North America in Coordinated Campaign',
    summary:
...
This campaign arrives amid heightened concern over the security of US critical infrastructure following a series of nation-state intrusions revealed in 2024. Security experts note that the line between financially-motivated cybercrime targeting critical infrastructure and state-sponsored sabotage is increasingly blurred, complicating attribution and response planning.`,
  ...
  },
  {
    ...
    body: `Google has issued an out-of-band security update for Chrome on all platforms—Windows, macOS, Linux, and Android—to address CVE-2025-0971, a critical zero-day vulnerability in the V8 JavaScript engine. The flaw is confirmed to be under active exploitation by threat actors in real-world attacks.
...
This marks the third actively exploited Chrome zero-day in the past six months. Security researchers note an increased market for browser zero-days, with prices on the private exploit market reportedly exceeding $3 million for a full Chrome RCE-plus-sandbox-escape chain. Browser vendors are responding by accelerating their patch cadence and increasing their bug bounty payouts.`,
    category: 'vulnerabilities',
    source: 'via Google Security Blog',
    sourceUrl: 'https://security.googleblog.com',
    publishedAt: '2025-01-12T16:45:00Z',
    severity: 'critical',
    tags: ['Chrome', 'zero-day', 'V8', 'RCE', 'CVE-2025-0971'],
  },
  {
    slug: 'cisa-emergency-directive-ivanti-2025',
    headline: 'CISA Issues Emergency Directive ED-25-02: Ivanti Connect Secure Exploitation Ongoing',
    summary:
...
"This is not a situation where agencies can wait for a convenient maintenance window," CISA Director Jen Easterly stated in a press call. "We are seeing active, ongoing exploitation by sophisticated threat actors. Disconnect first, then patch."`,
    category: 'policy',
    source: 'via CISA',
    sourceUrl: 'https://www.cisa.gov',
    publishedAt: '2025-01-11T18:00:00Z',
    severity: 'critical',
    tags: ['CISA', 'Ivanti', 'emergency directive', 'federal', 'CVE-2025-0282'],
  },
  {
    slug: 'ai-phishing-attacks-escalation-2025',
    headline: 'AI-Generated Phishing Campaigns Achieve 60% Higher Click Rates Than Human-Written Lures',
    summary:
    ...
    body: `A joint research report released by Proofpoint and Finnish security awareness firm Hoxhunt has quantified what security professionals have long feared: AI-generated phishing emails are measurably more effective than those written by human threat actors—and the gap is widening fast.
...
The report recommends organizations move away from click-rate metrics as the sole measure of phishing training effectiveness. Technical controls—advanced email security gateways with AI-based anomaly detection, hardware security keys (FIDO2/passkeys) as primary authentication, and privileged access management (PAM) solutions—are increasingly essential as the social engineering barrier falls. Additionally, employee training should shift from "spot the bad grammar" to behavioral cues and process verification (call-back verification for financial or credential requests).`,
    category: 'malware',
    source: 'via Proofpoint',
    sourceUrl: 'https://www.proofpoint.com',
    publishedAt: '2025-01-10T11:30:00Z',
    severity: 'high',
    tags: ['AI', 'phishing', 'social engineering', 'LLM', 'spear-phishing'],
  },
  {
    slug: 'aws-s3-misconfiguration-cloud-exposure',
    headline: '2.1 Billion Records Exposed in AWS S3 Misconfiguration Sweep Conducted by Security Researcher',
    summary:
...
AWS customers should enable S3 Block Public Access settings at the account level (not just bucket level), use AWS Config rules to continuously audit bucket policies, enable S3 server access logging and CloudTrail data events, and conduct regular automated scans using tools like Prowler, ScoutSuite, or AWS Security Hub. All API keys found in exposed buckets should be rotated immediately, regardless of whether they appear to have been accessed by unauthorized parties.`,
    category: 'breaches',
    source: 'via VPNMentor',
    sourceUrl: 'https://www.vpnmentor.com',
    publishedAt: '2025-01-09T13:00:00Z',
    severity: 'high',
    tags: ['AWS', 'S3', 'cloud', 'misconfiguration', 'data exposure'],
  },
  {
    slug: 'opencve-osint-tool-release',
    headline: 'Nuclei v3.4 Released: Community Adds 2,400 New Templates Including Cloud and AI Attack Surface Coverage',
    summary:
...
Mandiant recommends organizations in the DIB sector implement network traffic analysis for anomalous cloud provider egress patterns, enforce application allowlisting to block unauthorized process injection, and conduct proactive threat hunting for DUSTPAN-specific indicators of compromise (IOCs), which are published in the full report on Mandiant's website.`,
    category: 'malware',
    source: 'via Mandiant',
    sourceUrl: 'https://www.mandiant.com',
    publishedAt: '2025-01-07T15:30:00Z',
    severity: 'high',
    tags: ['APT41', 'China', 'espionage', 'DUSTPAN', 'defense', 'nation-state'],
  },
  {
    slug: 'bybit-crypto-exchange-hack-2025',
    headline: 'Bybit Cryptocurrency Exchange Loses $47M in Sophisticated Hot Wallet Compromise',
    summary:
      'Dubai-based Bybit confirmed that attackers drained $47 million in ETH, BTC, and stablecoins from its hot wallet infrastructure in what investigators are calling one of the most technically sophisticated exchange hacks of 2025. The attack exploited a multi-signature wallet vulnerability.',
...
Bybit stated that customer funds are protected by its $2 billion proof-of-reserves fund and that all withdrawals remain operational. The exchange has engaged law enforcement in the UAE, US, and South Korea.`,
    category: 'breaches',
    source: 'via Chainalysis',
    sourceUrl: 'https://www.chainalysis.com',
    publishedAt: '2025-01-06T20:00:00Z',
    severity: 'high',
    tags: ['cryptocurrency', 'exchange hack', 'Bybit', 'Lazarus Group', 'wallet'],
  },
  {
    slug: 'iot-critical-vulnerability-rtos',
    headline: 'Critical Memory Corruption Bugs in ThreadX RTOS Affect Billions of Embedded Devices',
    summary:
...
Network segmentation: isolate IoT devices on dedicated VLANs with strict firewall rules. Apply available firmware updates immediately when released by device vendors. Monitor for anomalous network behavior from embedded devices. Where possible, disable unused network services (DHCP client, Bluetooth LE, USB networking).`,
    category: 'vulnerabilities',
    source: 'via Forescout',
    sourceUrl: 'https://www.forescout.com',
    publishedAt: '2025-01-05T09:00:00Z',
    severity: 'critical',
    tags: ['IoT', 'RTOS', 'ThreadX', 'embedded', 'CVE', 'Microsoft'],
  },
  {
    slug: 'eu-cyber-resilience-act-enforcement',
    headline: 'EU Cyber Resilience Act Enters Enforcement Phase: Manufacturers Face €15M Fines for Non-Compliance',
    summary:
...
The CRA's extraterritorial scope—applying to any connected product sold in the EU regardless of where the manufacturer is based—means US, Asian, and other non-EU manufacturers must comply or exit the EU market. Security policy experts expect the CRA to function as a "Brussels Effect," raising cybersecurity standards for connected products globally as manufacturers implement CRA requirements across their entire product lines rather than maintaining EU-specific versions.`,
    category: 'policy',
    source: 'via EU Agency for Cybersecurity (ENISA)',
    sourceUrl: 'https://www.enisa.europa.eu',
    publishedAt: '2025-01-04T12:00:00Z',
    severity: null,
    tags: ['EU', 'CRA', 'regulation', 'compliance', 'IoT security', 'policy'],
  },
  {
    slug: 'npm-supply-chain-attack-malicious-packages',
    headline: 'Researchers Uncover 287 Malicious npm Packages Stealing Developer Credentials in Ongoing Supply Chain Attack',
    summary:
    ...
    body: `Socket Security, a supply chain security firm, has published findings on a sustained supply chain attack campaign targeting the npm JavaScript package registry. The investigation identified 287 malicious packages that collectively accumulated over 4 million downloads before being flagged and removed by npm security teams.
...
Security teams should audit their \`package.json\` and \`package-lock.json\` files against the published IOC list, rotate any credentials that may have been present in environments where npm installs occur, implement npm package integrity verification (npm audit + Socket scanning), and configure CI/CD environments to restrict environment variable access to only the steps that require them.`,
    category: 'malware',
    source: 'via Socket Security',
    sourceUrl: 'https://socket.dev',
    publishedAt: '2025-01-03T14:30:00Z',
    severity: 'high',
    tags: ['npm', 'supply chain', 'typosquatting', 'developer security', 'CI/CD'],
  },
  {
    slug: 'password-manager-security-audit-2025',
    headline: 'Independent Security Audit of Top 8 Password Managers Reveals Alarming Memory Handling Flaws',
    summary:
...
Check Point has published a full list of IOCs including file hashes, C2 domains, and known signing certificate serial numbers in their threat intelligence portal.`,
    category: 'malware',
    source: 'via Check Point Research',
    sourceUrl: 'https://research.checkpoint.com',
    publishedAt: '2025-01-01T08:00:00Z',
    severity: 'high',
    tags: ['macOS', 'malware', 'stealer', 'Banshee', 'Gatekeeper', 'Apple'],
  },
  {
    slug: 'cybersecurity-workforce-shortage-report-2025',
    headline: 'Global Cybersecurity Workforce Gap Reaches 4.8 Million: New ISC2 Study Highlights Diversity Crisis',
    summary:
